#!/bin/bash
# Launch 8 DreamShiftBlockN servers (1 per GPU)
# Usage: bash scripts/launch_blockN_8gpu.sh
#   MODEL_PATH=... CONFIG=... bash scripts/launch_blockN_8gpu.sh
...
CONFIG=${CONFIG:-dreamshift_blockN3_greedy_standard.yaml}
